...
\begin{tikzpicture}
    ...
    \node[sensor_p, right of = x_times, node distance=2.8em] (p) {$\bP^{\T}$ \\ \vspace{-0.35em}\scriptsize{$l\times n$}};
    ...
    \node[sensor_q, below of = p, node distance=7em] (q) {$\bQ^{\T}$ \\ \vspace{-0.35em}\scriptsize{$l\times r$}};
